              ...
              ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Wrap(
                      children: [
                        TextCustom(text: widget.product.nameProduct, fontSize: 25, fontWeight: FontWeight.bold )
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: const TextCustom(text: 'Shipping normally', fontSize: 18, color: Colors.white ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      child: Row(
                        children: const [
                          TextCustom(text: 'Available. ', fontSize: 18, color: Colors.green ),
                          TextCustom(text: 'In Stock', fontSize: 18, ),
                        ],
                      ),
                    ),
                  ), 
                  ...
                  const Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 20.0),
                    child: TextCustom(text: 'Description', fontSize: 20, fontWeight: FontWeight.bold ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Wrap(
                      children: [
                        TextCustom(text: widget.product.description, fontSize: 17)
                      ],
                    ),
                  ),
                  ...
                  const Padding(
                    ...
                    child: TextCustom(text: 'Payment methods', fontSize: 20, fontWeight: FontWeight.bold ),
                  ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        height: 55,
                        width: size.width * .45,
                        child: TextCustom(text: '\$ ${widget.product.price}', fontSize: 22, fontWeight: FontWeight.bold),
                      ),
                      // SizedBox(width: 15.0),
                      Container(
                        height: 55,
                        ...
                        child: TextButton(
                          ...
                          child: const TextCustom(text: 'Add to cart', fontSize: 20, color: Colors.white, fontWeight: FontWeight.w500 ),
                          onPressed: (){
