          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: const BorderRadius.only(topLeft: const Radius.circular(30.0), topRight: const Radius.circular(30.0)),
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const TextCustom(text: 'Total', fontSize: 23, fontWeight: FontWeight.w500 ),
                        BlocBuilder<ProductBloc, ProductState>(
                          builder: (context, state) 
                            => TextCustom(text: '\$ ${state.total.toStringAsFixed(2) }', fontSize: 24, fontWeight: FontWeight.bold, color: const Color(0xff0C6CF2)),
                        )
    ...
    return SafeArea(
      child: Column(
        children: [
          ...
          productBloc.product.isEmpty ? const WithoutProductsCart() : const DetailsProductsCart()
        ],
      ),
    );
  }
